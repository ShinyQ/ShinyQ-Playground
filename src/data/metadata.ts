...
export const metadata: Record<string, PageMetadata> = {
    home: {
        title: "Kurniadi Ahmad Wijaya – Software Engineer | Backend & Full-Stack Developer",
    ...
    about: {
        title: "About Kurniadi Ahmad Wijaya – Jakarta Software Engineer & Tech Enthusiast",
    ...
    projects: {
        title: "Projects – Portfolio of Kurniadi Ahmad Wijaya | Backend & Full-Stack Solutions",
    ...
    journey: {
        title: "Career Journey – Kurniadi Ahmad Wijaya | Software Engineering Milestones",
    ...
    notFound: {
        title: "404 – Page Not Found | Kurniadi Ahmad Wijaya",
